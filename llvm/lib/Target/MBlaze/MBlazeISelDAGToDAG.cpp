...
protected:
  /// Keep a pointer to the MBlazeSubtarget around so that we can make the right
...
bool MBlazeDAGToDAGISel::runOnMachineFunction(MachineFunction &MF) {
  Subtarget = &static_cast<const MBlazeSubtarget &>(MF.getSubtarget());
