/*
 * Automatically generated from ../../../src/libevent/test/regress.rpc
 */

#ifndef __________SRC_LIBEVENT_TEST_REGRESS_RPC_
#define __________SRC_LIBEVENT_TEST_REGRESS_RPC_
...
#endif  /* __________SRC_LIBEVENT_TEST_REGRESS_RPC_ */
